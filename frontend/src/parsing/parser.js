...
const selectDataType = function () {
  if (this.type === "IntProperty") return 1
  else if (this.type === "ArrayProperty") return 2
  else if (this.type === "StrProperty" || this.type === "NameProperty") return 3
  else if (this.type === "ByteProperty") return 4
  else if (this.type === "QWordProperty") return 5
  else if (this.type === "BoolProperty") return 6
  else if (this.type === "FloatProperty") return 7
}

const isNone = function () {
  if (this.name === "None") return 1
...
const StrProperty = new Parser()
  ...
  .buffer("value", {
    length: function () {
      if (this.value_length < 0) return this.value_length * -2
      else return this.value_length
    }
  })
...
const ByteProperty = new Parser()
  ...
  .string("value1", {
    encoding: "ascii",
    length: "value1_length",
    stripNull: true
  })
  .int32("value2_length")
  .string("value2", {
    encoding: "ascii",
    length: "value2_length",
    stripNull: true
  })
...
const FloatProperty = new Parser().endianess("little").float("value")
...
export const ReplayParser = new Parser()
  .endianess("little")
